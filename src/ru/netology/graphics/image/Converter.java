...
public class Converter implements TextGraphicsConverter{
    ...
    private int width;
    private int height;
    private double horizontalImgRatio;
    private double verticalImgRatio;
    ...
    public String convert(String url) throws IOException, BadImageSizeException {
        ...
        horizontalImgRatio = (double) img.getWidth() / img.getHeight();
        verticalImgRatio = (double) img.getHeight() / img.getWidth();
        ...
        return graphicImg.toString(); // Возвращаем собранный текст.
    }
